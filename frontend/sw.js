...
const CACHE = 'jarvis-voice-playback-fallback';
const SHELL = ['/', '/index.html', '/styles.css?v=voice-playback-fallback', '/app.js?v=voice-playback-fallback', '/manifest.json?v=voice-playback-fallback'];
